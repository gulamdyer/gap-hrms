...
const EmploymentTypeList = () => {
  const columns = [
    { key: 'EMPLOYMENT_TYPE_ID', label: 'ID', type: 'text', hidden: true },
    { key: 'EMPLOYMENT_TYPE_NAME', label: 'Employment Type', type: 'text' },
  ...
  return (
    <div className="space-y-6">
      ...
      <SettingsList
        ...
        description="Manage employment types (e.g., Permanent, Contract)"
        apiFunction={settingsAPI.getAllEmploymentTypes}
        deleteFunction={settingsAPI.deleteEmploymentType}
        basePath="/settings/employment-types"
        columns={columns}
