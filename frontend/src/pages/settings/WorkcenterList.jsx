...
const WorkcenterList = () => {
  const columns = [
    { key: 'WORKCENTER_ID', label: 'ID', type: 'text', hidden: true },
    { key: 'WORKCENTER_NAME', label: 'Workcenter Name', type: 'text' },
  ...
  return (
    <div className="space-y-6">
      ...
      <SettingsList
        title="Sections / Workcenters"
        description="Manage sections and workcenters"
        apiFunction={settingsAPI.getAllWorkcenters}
        deleteFunction={settingsAPI.deleteWorkcenter}
        basePath="/settings/workcenters"
        columns={columns}
        searchPlaceholder="Search workcenters..."
      />
    </div>
  );
};
